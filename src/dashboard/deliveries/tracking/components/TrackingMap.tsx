  ...
  return (
    <div className="overflow-hidden rounded-xl border border-border bg-surface/60 shadow-sm">
      ...
      >
        ...
        <rect x="240" y="40" width="160" height="100" rx="8" fill="rgba(10,10,10,0.04)" />
        <rect x="440" y="80" width="140" height="90" rx="8" fill="rgba(10,10,10,0.03)" />
        <rect x="160" y="180" width="200" height="90" rx="8" fill="rgba(10,10,10,0.04)" />
        <rect x="400" y="190" width="180" height="80" rx="8" fill="rgba(10,10,10,0.03)" />
